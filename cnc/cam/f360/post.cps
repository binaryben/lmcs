/**
  ...
  LMCS CNC Router post processor configuration.

  $Revision: 43976 30f784118b78098bfab508c19076f5ea1124289f $
  $Date: 2023-03-13 12:31:13 $

  FORKID {C601E17B-ED65-4897-AC13-EE84621953F2}
*/

description = "LMCS CNC Router";
vendor = "Lake Monger Community Shed";
vendorUrl = "https://www.lakemongershed.org.au";
legal = "Copyright (C) 2012-2022 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45821;

longDescription = "Post processor for the Lake Monger Community Shed CNC Router. Based on the official post for machines using a MASSO controller with modifications to enable machine simulation and set relevant defaults.";
...
// ####
// #### The code below is for machine simulation ####
// ####

// Start of machine simulation logic
...
// End of machine simulation logic
...
function onOpen() {
  ...
  if (false) { // (getProperty("fourthAxis") != "none") {
  ...
  writeln("")
  writeComment(localize("This program has been generated for the"));
  writeComment(localize("CNC at Lake Monger Community Shed"));
  writeln("")
  ...
  // Prestart workflow checks
  writeln("MSG Load material: confirm it's secure");
  writeBlock(mFormat.format(1));
  writeln("MSG Check 'Tools and Offsets' screen");
  writeBlock(mFormat.format(1));
  writeln("MSG Get supervisor approval to start");
  writeBlock(mFormat.format(1));
}
